package com.example.chouqu.presenter;
...
import com.example.chouqu.model.WanModel;
...
public class WanP extends BasePresenter<WanV>{
    ...
    private WanModel mWanModel;

    @Override
    protected void initModel() {
        mWanModel = new WanModel();
        mModels.add(mWanModel);
    }
    public void getData(){
        mWanModel.getData(new ResultCallBack<Fuli>() {
            @Override
